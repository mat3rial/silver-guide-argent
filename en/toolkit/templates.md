...
---
<img class="doc" src="{{ site.baseurl }}/assets/img/archive.svg" alt="LETTER OF AGREEMENT 1"/>[AGREEMENT SERVICE EXCHANGE]({{ site.baseurl }}/assets/template-en/agreement_contribution.doc) (.doc)
