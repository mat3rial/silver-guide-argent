...
<img class="doc" src="{{ site.baseurl }}/assets/img/archive.svg" alt="LETTER OF PARTNERSHIP AGREEMENT"/>[LETTER OF PARTNERSHIP AGREEMENT]({{ site.baseurl }}/assets/template-en/agreement_partnership.doc) (.doc)
